...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Inter&weight=500&size=22&duration=3000&pause=1000&color=0A66C2&center=true&vCenter=true&multiline=true&width=600&height=80&lines=10x+Salesforce+Certified+%7C+3+AppExchange+Apps;Building+Scalable+Enterprise+Solutions+Since+2017" alt="Typing SVG" />
</p>

<p align="center"><em>"One of the hidden treasures in the Salesforce Ecosystem"</em> — Client Testimonial</p>
...
<table>
  <tr>
    <td width="50%">
      ...
      <p>Apex, LWC, Aura, Visualforce, Flows, Triggers, SOQL/SOSL, Platform Events, Batch & Queueable Apex, Data Modeling, Security Architecture</p>
    </td>
    <td width="50%">
      <h3>🔗 Integration Specialist</h3>
      <p>20+ platforms connected. REST/SOAP APIs, MuleSoft, Named Credentials, OAuth, Middleware, Stripe, PandaDoc, DocuSign, Twilio</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>📦 AppExchange Publisher</h3>
      <p>Built 3 managed packages from scratch. ISV partner reviews, LMA setups, security reviews, licensing & packaging</p>
    </td>
    <td width="50%">
      <h3>💰 CPQ & Billing</h3>
      <p>Complex pricing rules, product bundling, subscription billing, quote automation, Stripe & payment integrations</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>📞 CTI & Telephony</h3>
      <p>Amazon Connect, RingCentral, 8x8, Service Cloud Voice, IVR systems, real-time transcription, call recording</p>
    </td>
    <td width="50%">
      <h3>☁️ Multi-Cloud</h3>
      <p>Sales Cloud, Service Cloud, Experience Cloud, Marketing Cloud, CPQ, Billing, NPSP, FSC, Health Cloud, Commerce B2C</p>
    </td>
  </tr>
</table>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Aura-00A1E0?style=flat-square&logo=salesforce&logoColor=white"/>
  <img src="https://img.shields.io/badge/Flows-00A1E0?style=flat-square&logo=salesforce&logoColor=white"/>
